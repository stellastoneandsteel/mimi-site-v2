...
export default function App() {
  ...
  const dropCrane = () => {
    ...
    const tick = setInterval(() => {
      frame += 1;
      setCraneWireLen(
        36 + Math.round((1 - Math.pow(1 - frame / maxFrames, 2)) * 120)
      );
      if (frame >= maxFrames) {
        clearInterval(tick);
        ...
        setTimeout(() => {
          ...
          setShowExcited(true);
          setTimeout(() => {
            (left ? forYouRef : forThemRef).current?.scrollIntoView({
              behavior: "smooth",
              block: "center",
            });
  ...
  const notifyArcade = (e) => {
    e.preventDefault();
    alert(
      "NOTIFY_ME(); — Arcade coming soon. Email: " + (arcadeEmail || "(empty)")
    );
  };
  const notifyNode = (e) => {
    e.preventDefault();
  ...
  return (
    <div
      className="crt-bezel-wrap"
      style={{
        minHeight: "100vh",
        background: DARK,
        border: "6px solid #000",
        boxShadow: "inset 0 0 0 3px #333, inset 0 0 0 6px #111",
      }}
    >
      {/* Disk boot overlay */}
      {diskBootVisible && (
        ...
        >
          <img
            ...
            alt=""
            style={{ width: 200, height: "auto", ...IMG_BASE }}
          />
          <div
            style={{
              width: 200,
      ...
      >
          ...
          >
            <div
              style={{
                ...
                transition:
                  "opacity 0.85s ease 0.2s, transform 0.85s ease 0.2s",
                pointerEvents: heroPhase === 1 ? "auto" : "none",
                zIndex: heroPhase === 1 ? 3 : 0,
              }}
            >
              <img
                src={A("mimi-mothership-3-transparent.png")}
                alt=""
                style={{
                  width: 200,
                  height: "auto",
              ...
              <div
                style={{
                  ...
                  animation: "hero-beam 2s ease-in-out infinite",
                  flexShrink: 0,
                }}
              />
              <div
              ...
              >
                ...
                <span style={{ animation: "hero-blink 1s step-end infinite" }}>
                  _
                </span>
              </div>
              <img
                src={A("mimi-hero-1-transparent.png")}
                alt="Mimi"
                style={{
                  width: 220,
                  height: "auto",
        ...
        >
          ...
          >
            <strong>Trademark:</strong> MIMI AI™ · USPTO #99682177 (Patent
            Pending)
            <br />
      ...
      <section style={sectionStyle()}>
        <ChapterBar>
          CHAPTER 2: MAKE_CONTACT(); // She&apos;s been waiting.
        </ChapterBar>
        <div
          style={{
            background: BG,
        ...
        >
          ...
          <PixelImg
            file="mimi-floppy-3-transparent.png"
            alt="Floppy"
            style={{ maxWidth: 100, margin: "12px auto 0" }}
          />
        </div>
      </section>
            ...
            >
              ...
              <div
                style={{
                  ...
                  justifyContent: "center",
                  outline:
                    craneGrabFlash && grabbed === "you"
                      ? `3px solid ${LIME}`
                      : "none",
                }}
              >
                <img
                  src={A("mimi-treat-you-v2-transparent.png")}
                  alt=""
                  style={{
                    width: "100%",
                    maxWidth: 88,
              ...
              <div
                style={{
                  ...
                  justifyContent: "center",
                  outline:
                    craneGrabFlash && grabbed === "them"
                      ? `3px solid ${LIME}`
                      : "none",
                }}
              >
                <img
                  src={A("mimi-treat-them-1-transparent.png")}
                  alt=""
                  style={{
                    width: "100%",
                    maxWidth: 88,
              ...
              <div
                style={{
                  ...
                  flexDirection: "column",
                  alignItems: "center",
                  transition: craneDropping
                    ? "none"
                    : "left 0.22s cubic-bezier(0.25,0.8,0.25,1)",
                  zIndex: 2,
                  pointerEvents: "none",
                }}
              >
        ...
        >
          <div
            ...
            style={{
              ...
              padding: 24,
              background: BG,
              outline: highlightYou ? `4px solid ${LIME}` : "none",
            }}
          >
            <PixelImg
          ...
          <div
            ...
            style={{
              padding: 24,
              background: BG,
              outline: highlightThem ? `4px solid ${LIME}` : "none",
            }}
          >
            <PixelImg
      ...
      <section style={sectionStyle()}>
        <ChapterBar>
          CHAPTER 5: CLOSE_DEAL(); // Ready to deploy Mimi?
        </ChapterBar>
        <div
          style={{
            background: DARK,
        ...
        >
          ...
          >
            <PixelImg
              file="mimi-crt-monitor-1-transparent.png"
              alt="CRT"
              style={{
                width: 750,
                maxWidth: "100%",
      ...
      <section style={sectionStyle()}>
        <ChapterBar>
          CHAPTER 6: MIMI_ARCADE(); // Missions incoming.
        </ChapterBar>
        <div
          className="scanlines"
          style={{
      ...
      <section style={sectionStyle()}>
        <ChapterBar>
          CHAPTER 7: MIMI_NODE(); // Hardware transmission incoming.
        </ChapterBar>
        <div
          className="scanlines"
          style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              <br />
              <br />// No screen. No internet. Just Mimi.
            ...
            >
              ...
              <br />
              <br />// Mila on your counter. Vitals on your wrist.
              <br />// STATUS: IN DEVELOPMENT
            </div>
          </div>
          <form
      ...
      <section style={sectionStyle()}>
        ...
        >
          <PixelImg
            file="mimi-vacation-transparent.png"
            alt="Vacation"
      ...
      <section style={sectionStyle()}>
        ...
        >
          ...
          >
            ▶ SEO Engine (weekly) | ▶ Social Content (2x daily) | ▶ Health
            Monitor (continuous) | ▶ SMS Digest (6am)
          </p>
        </div>
      </section>
      ...
      <section style={sectionStyle()}>
        <ChapterBar>
          ENLIST — MIMI_ENLIST(); // Reserve your unit.
        </ChapterBar>
        <div
          id="enlist"
        ...
        >
          ...
          >
            ...
            >
              Deploy Mimi on your site and ops. Stripe-secured checkout.
              Agreement + onboarding follow payment.
            </p>
            <ul
              style={{
                paddingLeft: 20,
          ...
          >
            ...
            >
              Limited spots available. Mimi works with businesses that are
              ready. When capacity is full, the waitlist opens.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          <img
            src={A("mimi-alien-parents-1-transparent.png")}
            alt=""
            style={{ width: 60, height: "auto", ...IMG_BASE }}
          />
          <img
            src={A("mimi-floppy-3-transparent.png")}
            alt=""
